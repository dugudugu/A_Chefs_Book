/* Add New Line for Recipe Ingredients */
 ...
 $(document).ready(function() {
     ...
     $("#addIngredient").click(function() {
         ...
         newLine.after().html(
             '<input id="recipe_ingredient" id="recipe_ingredients" name="recipe_ingredients" type="text" class="form-control mb-2" placeholder="List one ingredient per line" required>'
         );
...
$(document).ready(function() {
    ...
    $("#addInstruction").click(function() {
        ...
        var newLineInstruction = $(document.createElement('div'))
            .attr("id", 'TextBoxInstructionDiv' + instructionCount);

        newLineInstruction.after().html(
            '<textarea class="form-control mb-2" id="recipe_instruction" name="recipe_instruction" type="text" placeholder="List direction one per line"></textarea required>'
        );
